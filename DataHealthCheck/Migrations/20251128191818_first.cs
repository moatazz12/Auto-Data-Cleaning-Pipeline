        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnalysisSessionId = table.Column<int>(type: "int", nullable: false),
                    ...
                    UniqueValues = table.Column<int>(type: "int", nullable: false),
                    DuplicateValues = table.Column<int>(type: "int", nullable: false),
                    QualityScore = table.Column<decimal>(type: "decimal(4,3)", precision: 4, scale: 3, nullable: false),
                    BasicStatistics = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataPatterns = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CleanedBy = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CleanedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CleaningOperations = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RowsCount = table.Column<int>(type: "int", nullable: false),
                    ColumnsCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleanedDatasets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CleanedDatasets_AspNetUsers_CleanedBy",
                        column: x => x.CleanedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CleanedDatasets_CleanedBy",
                table: "CleanedDatasets",
                column: "CleanedBy");
